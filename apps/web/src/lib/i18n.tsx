...
const messages: Record<UiLanguage, Messages> = {
  en: {
    ...
    home: {
      ...
      dubbingEnabledHelp: "Turn this off to keep the original audio. Translation and burned-in subtitles still run.",
    ...
    task: {
      ...
      originalAudio: "Original audio with translated subtitles",
      resuming: "Resuming",
  ...
  zh: {
    ...
    home: {
      ...
      dubbingEnabledHelp: "关闭后保留视频原声，仍会翻译并压制字幕。",
      taskHistory: "任务历史",
