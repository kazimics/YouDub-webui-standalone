...
const messages: Record<UiLanguage, Messages> = {
  en: {
    ...
    home: {
      ...
      localSubtitleHelp: "When provided, the SRT is burned into the video and, when dubbing is enabled, used for voice generation. Whisper/OpenAI translation are skipped.",
      ...
      dubbingEnabledLabel: "Generate dubbed audio",
      dubbingEnabledHelp: "Turn this off to keep the original audio. Translation and burned-in bilingual subtitles still run.",
      bilibiliDraftEnabledLabel: "Upload Bilibili draft when finished",
      bilibiliDraftEnabledHelp: "On by default. When the task finishes, the final video is automatically uploaded to your Bilibili draft box; you can publish it later.",
      subtitleStyleTitle: "Subtitle appearance",
      subtitleChineseFont: "Chinese font",
      subtitleEnglishFont: "English font",
      subtitleChineseSize: "Chinese subtitle size",
      subtitleEnglishSize: "English subtitle size",
      subtitlePreview: "Subtitle preview",
      subtitlePreviewChinese: "这是一行中文字幕",
      subtitlePreviewEnglish: "This is an English subtitle",
    ...
    task: {
      ...
      finalAudioMode: "Final audio mode",
      dubbedAudio: "AI-generated dubbing",
      originalAudio: "Original audio with bilingual subtitles",
      subtitleChineseStyle: "Chinese subtitle",
      subtitleEnglishStyle: "English subtitle",
      resuming: "Resuming",
      ...
      bilibiliDraftHelper: "Saved as a draft only - you can review it in Bilibili and publish it manually later.",
      bilibiliDraftFieldTitle: "Title",
      bilibiliDraftFieldTid: "Partition ID",
      bilibiliDraftFieldTidHelper: "171 = Life, 138 = Tech, 208 = Daily",
      bilibiliDraftFieldTag: "Tags",
    ...
    settings: {
      ...
      concurrencyHelp: "Maximum parallel OpenAI requests during translation. Context batches are capped at 4 to avoid rate-limit spikes.",
      save: "Save settings",
      saving: "Saving",
      ...
      savedBilibiliCookie: "******** saved Bilibili cookie ********",
  ...
  zh: {
    ...
    home: {
      ...
      localSubtitleHelp: "上传后会直接用于压制字幕；开启配音时也会用于生成配音，并跳过 Whisper 识别与 OpenAI 翻译。",
      ...
      dubbingEnabledLabel: "生成配音",
      dubbingEnabledHelp: "关闭后保留视频原声，仍会翻译并压制中英双语字幕。",
      bilibiliDraftEnabledLabel: "完成后自动上传 B 站草稿",
      bilibiliDraftEnabledHelp: "默认开启。任务完成后会自动把成片上传到你的 B 站草稿箱，之后你随时可以手动发布。",
      subtitleStyleTitle: "字幕样式",
      subtitleChineseFont: "中文字体",
      subtitleEnglishFont: "英文字体",
      subtitleChineseSize: "中文字幕大小",
      subtitleEnglishSize: "英文字幕大小",
      subtitlePreview: "字幕效果预览",
      subtitlePreviewChinese: "这是一行中文字幕",
      subtitlePreviewEnglish: "This is an English subtitle",
      taskHistory: "任务历史",
    ...
    task: {
      ...
      executionAuto: "自动",
      executionManual: "手动",
      finalAudioMode: "最终音频模式",
      dubbedAudio: "AI 生成配音",
      originalAudio: "原声（带中英双语字幕）",
      subtitleChineseStyle: "中文字幕",
      subtitleEnglishStyle: "英文字幕",
      resuming: "继续中",
      resumeTask: "继续任务",
      runLog: "运行日志",
      emptyLog: "任务开始后会显示日志。",
      ...
      bilibiliDraftHelper: "仅保存为草稿，不会直接发布；之后可在 B 站检查并手动发布。",
      bilibiliDraftFieldTitle: "标题",
      bilibiliDraftFieldTid: "分区 ID",
      bilibiliDraftFieldTidHelper: "171 = 生活，138 = 科技，208 = 日常",
      bilibiliDraftFieldTag: "标签",
    ...
    settings: {
      ...
      concurrencyHelp: "翻译阶段并行发起的 OpenAI 请求数。上下文分块会限制为最多 4 路，避免触发服务商限流。",
      save: "保存设置",
      saving: "保存中",
      ...
      bilibiliCookie: "B 站 Cookie",
      savedBilibiliCookie: "******** 已保存 B 站 Cookie ********",
      bilibiliCookiePlaceholder:
